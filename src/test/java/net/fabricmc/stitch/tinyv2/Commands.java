...
public class Commands {
    ...
    private void testFieldNameProposal(String mergedJar, String mergedTinyFile, String newTinyFile) throws Exception{
    ...
    public void testFieldNameProposal() throws Exception{
        testFieldNameProposal("local/19w37a-merged.jar","src/test/resources/merged.tinyv2","src/test/resources/merged-proposed.tinyv2");
    }
}
